...
class PostController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $data = $request->validate([
            ...
            'body_image' => ['nullable', 'image', 'max:512000'],
            'body_audio' => ['nullable', 'mimetypes:audio/mpeg,audio/mp3,audio/wav,audio/ogg,audio/webm', 'max:20480'],
            'body_video' => ['nullable', 'mimetypes:video/mp4,video/webm,video/ogg,video/quicktime', 'max:51200'],
    ...
    public function update(Request $request, $postId): RedirectResponse
    {
        ...
        $data = $request->validate([
            ...
            'image' => ['nullable', 'image', 'max:512000'],
            'body_image' => ['nullable', 'image', 'max:512000'],
            'body_audio' => ['nullable', 'mimetypes:audio/mpeg,audio/mp3,audio/wav,audio/ogg,audio/webm', 'max:512000'],
            'body_video' => ['nullable', 'mimetypes:video/mp4,video/webm,video/ogg,video/quicktime', 'max:512000'],
            'excerpt' => ['nullable', 'string'],
            'body' => ['required', 'string'],
            'published' => ['nullable', 'boolean'],
        ]);
